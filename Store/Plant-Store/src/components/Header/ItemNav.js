...
const ItemNav = () => {
  ...
  return (
        <nav className='flex h-18 py-4 w-full m-auto text-gray-800'>
            <Link to='/'>
                <h1 className="text-2xl md:text-5xl transform duration-300 hover:-translate-y-1 font-display font-thin tracking-wide m-auto pl-4 md:pl-12">GREEN UNIVERSE</h1>
            </Link>
